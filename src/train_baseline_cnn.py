...
def save_training_curves(history):
    output_path = RESULTS_DIR / "baseline_cnn_training_curves.png"
    ...
    plt.title("Baseline CNN Training Curves")
    plt.tight_layout()
...
def save_confusion_matrix(y_true, y_pred, class_names):
    output_path = RESULTS_DIR / "baseline_cnn_confusion_matrix.png"
