...
def train_one_epoch(model, dataloader, criterion, optimizer, device):
    ...
    # Keep the pretrained BatchNorm running statistics fixed with the frozen
    # backbone. Only the replacement classification head is optimized.
...
def save_history(history):
    output_path = RESULTS_DIR / "resnet18_history.csv"
    fieldnames = [
        "epoch",
        "train_loss",
        "train_accuracy",
...
def save_metrics(
    ...
    output_path = RESULTS_DIR / "resnet18_metrics.json"
    metrics = {
